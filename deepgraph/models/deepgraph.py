...
from ..modules import init_graphormer_params, DeepGraphGraphEncoder
...
class DeepGraphEncoder(FairseqEncoder):
    def __init__(self, args):
        super().__init__(dictionary=None)
        self.max_nodes = args.max_nodes

        self.graph_encoder = DeepGraphGraphEncoder(
            # < for graphormer
...
@register_model_architecture("deepgraph", "graphormer")
...
@register_model_architecture("deepgraph", "graphormer_base")
...
@register_model_architecture("deepgraph", "graphormer_slim")
...
@register_model_architecture("deepgraph", "graphormer_large")
